...
export const testimonialData = [
  {
    ...
    content:
      "QuickAI has completely changed the way I work. I can now generate high-quality blog posts and images in minutes instead of hours. It's a must-have for any serious creator.",
    rating: 5
  },
  {
    name: "Richard Nelson",
    ...
    content:
      "Thanks to QuickAI, I no longer worry about captions, visuals, or hashtags. The AI tools are smart, fast, and incredibly easy to use. It’s like having a full creative team in one platform.",
    rating: 5
  },
  {
    ...
    content:
      "QuickAI has streamlined our content production pipeline. From article generation to image design, it delivers professional results that save us time and budget.",
    rating: 5
  }
];
